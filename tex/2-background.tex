...
Depending on the training configuration, the problem can be interpreted as a classification problem or regression problem. In the following experiments, the former approach is selected. 
...
Central to the advancement of learned strategies in \gls{BnB} is the interpretation of the solution algorithm as a \emph{Markov Decision Process} (\gls{MDP}). 
