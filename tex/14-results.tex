...
\begin{figure}[h]
    \begin{tikzpicture}
      ...
      \end{axis}
    \end{tikzpicture}
    \caption{---PLACEHOLDER--- Training graph for MLP2 on the combinatorial auctions data set.}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
      ...
      \end{axis}
    \end{tikzpicture}
    \caption{---PLACEHOLDER--- Training graph for GNN1 on the set covering data set.}
